    ...
    <div className="space-y-8">
      ...
      <div className="bg-amber-50 border border-amber-200 rounded-md p-4">
        <div className="flex">
          ...
          <div className="ml-3">
            <h3 className="text-sm font-medium text-amber-800">Responsabilidades do Intermediário</h3>
            <div className="text-sm text-amber-700 mt-1">
              <ul className="list-disc list-inside space-y-1">
                <li>Deve possuir autorização legal para atuar como intermediário</li>
                <li>É responsável pela veracidade dos dados informados</li>
                <li>Pode ser responsabilizado solidariamente pelos tributos</li>
                <li>Deve manter registros da operação conforme legislação</li>
                <li>Para operações internacionais, verificar acordo de bitributação</li>
              </ul>
            </div>
          </div>
        </div>
